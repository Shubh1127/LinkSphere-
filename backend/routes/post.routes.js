...
import { commentPost,increment_Likes ,getAllComments ,deleteComment,getCommentsByPostId} from "../controllers/post.controllers.js";
...
router.route("/get_comments").get(getCommentsByPostId)
